(function () {
  ...
  function mount(selector, initialProps, name) {
    return $(selector).map((element) =>
      mountComponent(element, initialProps),
    )
  }
  ...
  var App = {
    ...
    template: (
      ...
      '<div class="min-h-screen min-w-screen bg-gray-900 text-gray-100 grid grid-rows-2 grid-cols-3"><div class="flex flex-col items-center justify-center bg-gray-950 p-4 border border-gray-800"><circle-of-fifths expr0="expr0"></circle-of-fifths><div class="mt-4 space-y-4 w-full"><label for="scale-mode" class="mb-1 font-semibold">Scale:</label><select expr1="expr1" id="scale-mode" class="w-full bg-gray-800 p-2 rounded shadow border border-gray-700"><option expr2="expr2" value="Major Scale">Major Scale</option><option expr3="expr3" value="Natural Minor">Natural Minor</option><option expr4="expr4" value="Major Pentatonic">Major Pentatonic</option><option expr5="expr5" value="Minor Pentatonic">Minor Pentatonic</option><option expr6="expr6" value="Major Blues">Major Blues</option><option expr7="expr7" value="Minor Blues">Minor Blues</option></select></div></div><fingering-chart expr8="expr8" class="flex flex-col items-center justify-center bg-gray-800 p-4 border border-gray-700"></fingering-chart></div>',
      [
        {
          type: bindingTypes.TAG,
          getComponent: getComponent,
          evaluate: _scope => 'circle-of-fifths',
          slots: [],
          ...
          attributes: [
            {
              ...
              isBoolean: false,
              name: 'selected-key',
              evaluate: _scope => _scope.state.selectedKey
            },
            {
              type: expressionTypes.EVENT,
              name: 'on-key-select',
              evaluate: _scope => _scope.setSelectedKey
            },
            {
              type: expressionTypes.ATTRIBUTE,
              isBoolean: false,
              name: 'selected-label-mode',
              evaluate: _scope => _scope.state.labelMode
            },
            {
              type: expressionTypes.EVENT,
              name: 'on-label-mode-select',
              evaluate: _scope => _scope.setLabelMode
            }
          ],
          ...
          expressions: [
            {
              type: expressionTypes.EVENT,
              name: 'onchange',
              evaluate: _scope => _scope.setScaleMode
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              isBoolean: true,
              name: 'selected',
              evaluate: _scope => _scope.state.scaleMode === 'Major Scale'
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              isBoolean: true,
              name: 'selected',
              evaluate: _scope => _scope.state.scaleMode === 'Natural Minor'
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              isBoolean: true,
              name: 'selected',
              evaluate: _scope => _scope.state.scaleMode === 'Major Pentatonic'
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              isBoolean: true,
              name: 'selected',
              evaluate: _scope => _scope.state.scaleMode === 'Minor Pentatonic'
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              isBoolean: true,
              name: 'selected',
              evaluate: _scope => _scope.state.scaleMode === 'Major Blues'
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              isBoolean: true,
              name: 'selected',
              evaluate: _scope => _scope.state.scaleMode === 'Minor Blues'
            }
          ]
        },
        {
            ...
            [
              {
                type: bindingTypes.TAG,
                getComponent: getComponent,
                evaluate: _scope => 'fingering-chart',
                slots: [],
                ...
                attributes: [
                  ...
                  },
                  {
                    ...
                    isBoolean: false,
                    name: 'position',
                    evaluate: _scope => _scope.position
                  },
                  {
                    type: expressionTypes.ATTRIBUTE,
                    isBoolean: false,
                    name: 'mode',
                    evaluate: _scope => _scope.state.scaleMode
                  },
                  {
                    type: expressionTypes.ATTRIBUTE,
                    isBoolean: false,
          ...
          itemName: 'position',
          indexName: null,
          evaluate: _scope => _scope.state.cagedPositions
        }
      ]
    )};

  var CircleOfFifths = {
    css: `circle-of-fifths .key-button,[is="circle-of-fifths"] .key-button{ padding: 0.5rem; border-radius: 9999px; transition: transform 0.2s; cursor: pointer; } circle-of-fifths .key-button:hover,[is="circle-of-fifths"] .key-button:hover{ transform: scale(1.1); } circle-of-fifths .selected,[is="circle-of-fifths"] .selected{ background-color: #f59e0b; } circle-of-fifths .unselected,[is="circle-of-fifths"] .unselected{ background-color: #374151; } circle-of-fifths .circle-svg,[is="circle-of-fifths"] .circle-svg{ margin: auto; }`,
    ...
    template: (
      ...
      '<div class="flex items-center justify-center"><div class="flex flex-col items-center space-y-2 mr-4"><button expr9="expr9" title="Clean">\n                👁️‍🗨️\n            </button><button expr10="expr10" title="Intervals"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><text x="0" y="17" font-size="14" font-weight="bold">123</text></svg></button><button expr11="expr11" title="Note Names">\n                🎵\n            </button></div><svg width="300" height="300" viewBox="0 0 300 300" class="circle-svg mx-auto"><circle expr12="expr12" fill="none" stroke="#444" stroke-width="2"/><image expr13="expr13" href="logo.png" width="120" height="120"></image><g expr14="expr14" style="cursor: pointer"></g></svg></div>',
      [
        {
          ...
          expressions: [
            {
              ...
              evaluate: _scope => [
                'key-button p-2 rounded-full transition-transform transform hover:scale-110 ',
                _scope.props.selectedLabelMode === 'none' ? 'selected' : 'unselected'
              ].join(
                ''
              )
            },
            {
              type: expressionTypes.EVENT,
              name: 'onclick',
              evaluate: _scope => () => _scope.selectLabelMode('none')
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              evaluate: _scope => [
                'key-button p-2 rounded-full transition-transform transform hover:scale-110 ',
                _scope.props.selectedLabelMode === 'intervals' ? 'selected' : 'unselected'
              ].join(
                ''
              )
            },
            {
              type: expressionTypes.EVENT,
              name: 'onclick',
              evaluate: _scope => () => _scope.selectLabelMode('intervals')
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              evaluate: _scope => [
                'key-button p-2 rounded-full transition-transform transform hover:scale-110 ',
                _scope.props.selectedLabelMode === 'notes' ? 'selected' : 'unselected'
              ].join(
                ''
              )
            },
            {
              type: expressionTypes.EVENT,
              name: 'onclick',
              evaluate: _scope => () => _scope.selectLabelMode('notes')
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              isBoolean: false,
              name: 'cx',
              evaluate: _scope => _scope.state.center
            },
            {
              type: expressionTypes.ATTRIBUTE,
              isBoolean: false,
            ...
            },
            {
              ...
              isBoolean: false,
              name: 'r',
              evaluate: _scope => _scope.state.radius
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              isBoolean: false,
              name: 'x',
              evaluate: _scope => _scope.state.center - 60
            },
            {
              type: expressionTypes.ATTRIBUTE,
              isBoolean: false,
        ...
        },
        {
          ...
          template: template(
            '<circle expr15="expr15" r="16"/><text expr16="expr16" font-size="12" text-anchor="middle" dominant-baseline="middle"> </text><text expr17="expr17" fill="#9ca3af" font-size="12" text-anchor="middle" dominant-baseline="middle"> </text>',
            [
              {
                expressions: [
                  {
                    type: expressionTypes.EVENT,
                    name: 'onmouseenter',
                    evaluate: _scope => () => _scope.setHovered(_scope.index)
                  },
                  {
                    type: expressionTypes.EVENT,
                    name: 'onmouseleave',
                    evaluate: _scope => () => _scope.clearHovered()
                  },
                  {
                    type: expressionTypes.EVENT,
                    name: 'onclick',
                    evaluate: _scope => () => _scope.selectKey(_scope.key.major)
                  }
                ]
              },
              {
                ...
                expressions: [
                  {
                    ...
                    isBoolean: false,
                    name: 'cx',
                    evaluate: _scope => _scope.state.center + _scope.state.radius * Math.cos(_scope.state.angleStep * _scope.index - Math.PI / 2)
                  },
                  {
                    type: expressionTypes.ATTRIBUTE,
                    isBoolean: false,
                    name: 'cy',
                    evaluate: _scope => _scope.state.center + _scope.state.radius * Math.sin(_scope.state.angleStep * _scope.index - Math.PI / 2)
                  },
                  {
                    type: expressionTypes.ATTRIBUTE,
                    isBoolean: false,
                    ...
                    evaluate: _scope => _scope.getCircleFillColor(
                      _scope.key,
                      _scope.index
                    )
                  },
                  {
                    ...
                    evaluate: _scope => _scope.getStrokeColor(
                      _scope.key,
                      _scope.index
                    )
                  }
              ...
              },
              {
                ...
                expressions: [
                  ...
                  },
                  {
                    ...
                    isBoolean: false,
                    name: 'fill',
                    evaluate: _scope => _scope.key.major === _scope.props.selectedKey ? '#000000' : '#f3f4f6'
                  }
                ]
              },
              {
                ...
                expressions: [
                  ...
                  },
                  {
                    ...
                    isBoolean: false,
                    name: 'x',
                    evaluate: _scope => _scope.state.center + (_scope.state.radius-30) * Math.cos(_scope.state.angleStep * _scope.index - Math.PI / 2)
                  },
                  {
                    type: expressionTypes.ATTRIBUTE,
                    isBoolean: false,
                    name: 'y',
                    evaluate: _scope => _scope.state.center + (_scope.state.radius-30) * Math.sin(_scope.state.angleStep * _scope.index - Math.PI / 2)
                  }
                ]
              }
            ]
          ...
          itemName: 'key',
          indexName: 'index',
          evaluate: _scope => _scope.state.keys
        }
      ]
    )};

  class CagedNote {
      constructor(interval, string, fret) {
  ...
  class CagePositionFinder {
      ...
      getNoteSemitoneRelativeToC(note) {
      ...
      getStartFret(key, cagedNotes) {
          ...
          if (possibleStartFrets.length === 0)
              return 0;
      ...
      getScaleModePosition(scaleMode, position, key) {
          switch (position) {
              case 'C':
      ...
      getScale(mode, position, key) {
          const cagedPosition = this.getScaleModePosition(this.getScaleMode(mode), position, key);
          const notes = [];
          let string = 0;
  ...
  class NoteFinder {
      ...
      getChromaticNotesForMajorKey(key) {
          switch (key) {
              case 'C':
              case 'G':
              case 'D':
              ...
              case 'E':
              case 'B':
              case 'F♯': return chromaticSharps;
              default: return chromaticFlats;
          }
      }
      getChromaticNotesForMinorKey(key) {
          switch (key) {
              case 'A':
              case 'E':
              case 'B':
  ...
  var FingeringChart = {
    css: `fingering-chart text,[is="fingering-chart"] text{ font-family: 'serif'; letter-spacing: 1px; }`,
    ...
    template: (
      ...
      '<svg expr18="expr18" preserveAspectRatio="xMidYMid meet" class="w-full h-auto"><rect expr19="expr19" x="0"/><text expr20="expr20" x="10" y="18" text-anchor="middle" font-size="20" font-weight="bold" fill="white" style="font-family: \'serif\';"> </text><g expr21="expr21"></g><g expr23="expr23"></g><g expr25="expr25"></g><g expr27="expr27"></g></svg>',
      [
        {
          ...
          expressions: [
            {
              ...
              isBoolean: false,
              name: 'viewBox',
              evaluate: _scope => "0 0 " + _scope.state.width + " " + (_scope.state.paddedHeight + _scope.state.topOffset)
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              isBoolean: false,
              name: 'y',
              evaluate: _scope => _scope.state.topOffset
            },
            {
              type: expressionTypes.ATTRIBUTE,
              isBoolean: false,
              name: 'height',
              evaluate: _scope => _scope.state.paddedHeight
            },
            {
              type: expressionTypes.ATTRIBUTE,
              isBoolean: false,
              name: 'width',
              evaluate: _scope => _scope.state.width
            },
            {
              type: expressionTypes.ATTRIBUTE,
              isBoolean: false,
              name: 'fill',
              evaluate: _scope => _scope.state.colors.ebony
            }
          ]
        },
        {
          ...
          expressions: [
            {
              ...
              evaluate: _scope => [
                _scope.props.position.charAt(0).toUpperCase()
              ].join(
                ''
              )
            }
        ...
        },
        {
          ...
          template: template(
            '<text expr22="expr22" y="18" text-anchor="middle" font-size="10" fill="gray"> </text>',
            [
              {
                ...
                expressions: [
                  {
                    ...
                    evaluate: _scope => [
                      _scope.state.startFret + _scope.index
                    ].join(
                      ''
                    )
                  },
                  {
                    ...
                    isBoolean: false,
                    name: 'x',
                    evaluate: _scope => (_scope.index + 1) * _scope.state.fretSpacing - _scope.state.fretSpacing / 2
                  }
                ]
              }
            ]
                ...
                expressions: [
                  {
                    ...
                    evaluate: _scope => _scope.getFretX(
                      _scope.index
                    )
                  },
                  {
                  ...
                  },
                  {
                    ...
                    isBoolean: false,
                    name: 'y2',
                    evaluate: _scope => _scope.state.paddedHeight + _scope.state.topOffset
                  },
                  {
                    type: expressionTypes.ATTRIBUTE,
                    isBoolean: false,
                    name: 'stroke',
                    evaluate: _scope => _scope.state.colors.silver
                  },
                  {
                    type: expressionTypes.ATTRIBUTE,
                    isBoolean: false,
                    name: 'stroke-width',
                    evaluate: _scope => _scope.index === 0 ? 4 : 2
                  }
                ]
              }
            ]
        ...
        },
        {
          ...
          template: template(
            '<line expr26="expr26" x1="0" stroke-linecap="round"/>',
            [
              {
                ...
                expressions: [
                  {
                    ...
                    evaluate: _scope => _scope.getStringY(
                      _scope.index
                    )
                  },
                  {
                  ...
                  },
                  {
                    ...
                    isBoolean: false,
                    name: 'stroke',
                    evaluate: _scope => _scope.state.colors.bronze
                  },
                  {
                    type: expressionTypes.ATTRIBUTE,
                    isBoolean: false,
                    ...
                    evaluate: _scope => _scope.getStringStrokeWidth(
                      _scope.index
                    )
                  }
                ]
        ...
        },
        {
          ...
          template: template(
            '<g><circle expr28="expr28" r="12" stroke="black" stroke-width="1.5"/><text expr29="expr29" font-size="10" font-weight="bold" fill="black" text-anchor="middle" dominant-baseline="middle"></text><text expr30="expr30" font-size="10" font-weight="bold" fill="black" text-anchor="middle" dominant-baseline="middle"></text></g>',
            [
              {
                ...
                expressions: [
                  {
                    ...
                    evaluate: _scope => _scope.getNoteX(
                      _scope.value
                    )
                  },
                  {
                    ...
                    evaluate: _scope => _scope.getNoteY(
                      _scope.value
                    )
                  },
                  {
                    ...
                    isBoolean: false,
                    name: 'fill',
                    evaluate: _scope => _scope.value.interval === '1' ? 'red' : 'yellow'
                  }
                ]
              },
              {
                type: bindingTypes.IF,
                evaluate: _scope => _scope.props.labelMode === 'intervals',
                  ...
                  [
                    {
                      expressions: [
                        ...
                        },
                        {
                          ...
                          isBoolean: false,
                          name: 'y',
                          evaluate: _scope => _scope.getNoteY(_scope.value) + 2
                        }
                      ]
                    }
                  ]
              ...
              {
                type: bindingTypes.IF,
                evaluate: _scope => _scope.props.labelMode === 'notes',
                      ...
                      expressions: [
                        {
                          ...
                          evaluate: _scope => [
                            _scope.state.scaleNotes[_scope.value.interval]
                          ].join(
                            ''
                          )
                        },
          ...
          itemName: 'value',
          indexName: null,
          evaluate: _scope => _scope.state.cagedNotes
        }
      ]
    )};
